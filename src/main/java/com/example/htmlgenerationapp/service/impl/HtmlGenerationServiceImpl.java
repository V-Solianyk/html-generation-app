...
public class HtmlGenerationServiceImpl implements HtmlGenerationService {
    ...
    private static final String GENERATED_CONTENT_START = "<p>This is generated content"
            + " from thread ";
    ...
    public String generateHtmlPage() {
        ...
        StringBuilder htmlContent = collectGenerationContentFromEachThread(futures);
    ...
    private StringBuilder collectGenerationContentFromEachThread(Set<Future<String>> futures) {
